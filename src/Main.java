...
public class Main {
    public static void main(String[] args) {
        ...
        final String phrase = "тебе уважаемый человек здоровья и побольше";
        Function<String, List<String>> valueConverter = x -> {
            ...
            List<String> str1 = (List<String>) stream1.sorted(Comparator.naturalOrder()).collect(Collectors.toList());
            return str1;
        };
